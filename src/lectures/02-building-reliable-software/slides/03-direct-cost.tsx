        ...
        <LectureContentSlide number={2}>
            ...
            >
                <div>
                    ...
                    <p>
                        Практика показывает, что со сбоями борятся не из-за
                ...
                <Panel css={theme.backgrounds.gradient('accent-3')}>
                    ...
                    <p>
                        Потери репутации страшнее и не поддаются рассчетам.
                        Чтобы быть в определенной "лиге" надо показывать
                        определенную доступность
                    </p>
                </Panel>
            </div>
        </LectureContentSlide>
